        ...
        <div className={s.structure}>
            <div className={s.proportion}>
                <div className={s.head}>
                    ...
                    <div className={s.tab}>
                        <span onClick={() => changePieType('expense')} className={cx({ [s.expense]: true, [s.active]: totalType === 'expense' })}>支出</span>
                        <span onClick={() => changePieType('income')} className={cx({ [s.income]: true, [s.active]: totalType === 'income' })}>收入</span>
                    </div>
                </div>
                {/* 这是用于放置饼图的 DOM 节点 */}
                <div id="proportion"/>
